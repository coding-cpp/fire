...
bool Reloader::isValidFile(const std::string& filename) {
  // check for extension
...
bool Reloader::isValidDirectory(const std::string& path) {
...
void Reloader::addWatchRecursively(const std::string& path) {
